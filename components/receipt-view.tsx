 ...
 * visual do orçamento enviado por e-mail. O total é sempre destacado em reais.
 */
    ...
    <div className="mx-auto max-w-2xl bg-card text-card-foreground">
      <div className="border-b p-6">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 className="text-xl font-semibold tracking-tight">{order.storeName}</h1>
        ...
        <div className="mt-4 flex justify-end">
          <div className="w-full max-w-xs">
            ...
            <p className="mt-1 text-right text-xs text-muted-foreground">
              Equivalente a {formatUSD(order.totalUsd)} · câmbio R$ {Number(order.exchangeRate).toFixed(2)}
            </p>
          </div>
        </div>
